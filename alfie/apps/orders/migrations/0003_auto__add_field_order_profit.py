...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.profit'
        db.add_column('orders_order', 'profit',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.profit'
        db.delete_column('orders_order', 'profit')
    ...
    models = {
        ...
        'orders.menu': {
            ...
            'slots': ('django.db.models.fields.IntegerField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
        'orders.order': {
            ...
            'profit': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        'ramens.box': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'boxes'", 'null': 'True', 'to': "orm['orders.Menu']"}),
            'month': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'notes': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'profit': ('django.db.models.fields.IntegerField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
