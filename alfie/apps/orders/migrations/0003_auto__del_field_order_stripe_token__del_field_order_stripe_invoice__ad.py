...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.stripe_token'
        db.delete_column('orders_order', 'stripe_token')

        # Deleting field 'Order.stripe_invoice'
        db.delete_column('orders_order', 'stripe_invoice')

        # Adding field 'Order.coupon'
        db.add_column('orders_order', 'coupon',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Menu.size'
        db.delete_column('orders_menu', 'size')

        # Adding field 'Menu.slots'
        db.add_column('orders_menu', 'slots',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.stripe_token'
        db.add_column('orders_order', 'stripe_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.stripe_invoice'
        db.add_column('orders_order', 'stripe_invoice',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Order.coupon'
        db.delete_column('orders_order', 'coupon')

        # Adding field 'Menu.size'
        db.add_column('orders_menu', 'size',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Menu.slots'
        db.delete_column('orders_menu', 'slots')
