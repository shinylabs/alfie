...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.gotshipped'
        db.delete_column('orders_order', 'gotshipped')

        # Deleting field 'Order.gotpacked'
        db.delete_column('orders_order', 'gotpacked')

        # Deleting field 'Order.gotpaid'
        db.delete_column('orders_order', 'gotpaid')

        # Adding field 'Order.paid'
        db.add_column('orders_order', 'paid',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.packed'
        db.add_column('orders_order', 'packed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipped'
        db.add_column('orders_order', 'shipped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.gotshipped'
        db.add_column('orders_order', 'gotshipped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.gotpacked'
        db.add_column('orders_order', 'gotpacked',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.gotpaid'
        db.add_column('orders_order', 'gotpaid',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Order.paid'
        db.delete_column('orders_order', 'paid')

        # Deleting field 'Order.packed'
        db.delete_column('orders_order', 'packed')

        # Deleting field 'Order.shipped'
        db.delete_column('orders_order', 'shipped')
