...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_menu', (
            ...
            ('slots', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('price', self.gf('django.db.models.fields.IntegerField')(max_length=7)),
        ...
        db.create_table('orders_order', (
            ...
            ('box', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders', null=True, to=orm['ramens.Box'])),
            ('coupon', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ...
            ('packed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('tracker', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('label_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('label_file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ...
            ('refunded', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('product_cost', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True)),
            ('prize_cost', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True)),
            ('prints_cost', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True)),
            ('packaging_cost', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True)),
            ('shipping_cost', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True)),
            ('stripe_fee', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7, null=True, blank=True)),
