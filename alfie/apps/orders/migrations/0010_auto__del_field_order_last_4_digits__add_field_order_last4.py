...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.last_4_digits'
        db.delete_column('orders_order', 'last_4_digits')

        # Adding field 'Order.last4'
        db.add_column('orders_order', 'last4',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.last_4_digits'
        db.add_column('orders_order', 'last_4_digits',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Order.last4'
        db.delete_column('orders_order', 'last4')
