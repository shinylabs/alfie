...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.last4'
        db.alter_column('orders_order', 'last4', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True))

    def backwards(self, orm):

        # Changing field 'Order.last4'
        db.alter_column('orders_order', 'last4', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
