...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.tracker'
        db.add_column('orders_order', 'tracker',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.label_url'
        db.add_column('orders_order', 'label_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.label_file'
        db.add_column('orders_order', 'label_file',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.tracker'
        db.delete_column('orders_order', 'tracker')

        # Deleting field 'Order.label_url'
        db.delete_column('orders_order', 'label_url')

        # Deleting field 'Order.label_file'
        db.delete_column('orders_order', 'label_file')
