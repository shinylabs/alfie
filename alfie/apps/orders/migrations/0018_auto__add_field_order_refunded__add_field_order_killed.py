...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.refunded'
        db.add_column('orders_order', 'refunded',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.killed'
        db.add_column('orders_order', 'killed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.refunded'
        db.delete_column('orders_order', 'refunded')

        # Deleting field 'Order.killed'
        db.delete_column('orders_order', 'killed')
