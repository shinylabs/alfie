...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.product_cost'
        db.add_column('orders_order', 'product_cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.prize_cost'
        db.add_column('orders_order', 'prize_cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.prints_cost'
        db.add_column('orders_order', 'prints_cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.packaging_cost'
        db.add_column('orders_order', 'packaging_cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_cost'
        db.add_column('orders_order', 'shipping_cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.stripe_fee'
        db.add_column('orders_order', 'stripe_fee',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.product_cost'
        db.delete_column('orders_order', 'product_cost')

        # Deleting field 'Order.prize_cost'
        db.delete_column('orders_order', 'prize_cost')

        # Deleting field 'Order.prints_cost'
        db.delete_column('orders_order', 'prints_cost')

        # Deleting field 'Order.packaging_cost'
        db.delete_column('orders_order', 'packaging_cost')

        # Deleting field 'Order.shipping_cost'
        db.delete_column('orders_order', 'shipping_cost')

        # Deleting field 'Order.stripe_fee'
        db.delete_column('orders_order', 'stripe_fee')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'packaging_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'payment_attempts': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'prints_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'prize_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'product_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'shipped': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'shipping_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'stripe_fee': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
