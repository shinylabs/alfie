...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Menu.slots'
        db.alter_column('orders_menu', 'slots', self.gf('django.db.models.fields.IntegerField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Menu.slots'
        db.alter_column('orders_menu', 'slots', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
