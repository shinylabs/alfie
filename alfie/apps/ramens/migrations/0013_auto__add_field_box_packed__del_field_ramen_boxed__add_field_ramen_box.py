...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Box.packed'
        db.add_column('ramens_box', 'packed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ramen.boxed'
        db.delete_column('ramens_ramen', 'boxed')

        # Adding field 'Ramen.boxing'
        db.add_column('ramens_ramen', 'boxing',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ramen.shipped'
        db.add_column('ramens_ramen', 'shipped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Box.packed'
        db.delete_column('ramens_box', 'packed')

        # Adding field 'Ramen.boxed'
        db.add_column('ramens_ramen', 'boxed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ramen.boxing'
        db.delete_column('ramens_ramen', 'boxing')

        # Deleting field 'Ramen.shipped'
        db.delete_column('ramens_ramen', 'shipped')
