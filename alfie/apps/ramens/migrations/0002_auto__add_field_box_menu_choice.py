...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ramens_box', 'menu_choice',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='menu_choice_by_user', null=True, to=orm['orders.Menu']),
                      keep_default=False)
    ...
    models = {
        ...
        'ramens.box': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu_choice': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'menu_choice_by_user'", 'null': 'True', 'to': "orm['orders.Menu']"}),
