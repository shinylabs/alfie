...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ramen.price'
        db.delete_column('ramens_ramen', 'price')

        # Adding field 'Ramen.cogs'
        db.add_column('ramens_ramen', 'cogs',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Ramen.msrp'
        db.add_column('ramens_ramen', 'msrp',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ramen.price'
        db.add_column('ramens_ramen', 'price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Ramen.cogs'
        db.delete_column('ramens_ramen', 'cogs')

        # Deleting field 'Ramen.msrp'
        db.delete_column('ramens_ramen', 'msrp')
