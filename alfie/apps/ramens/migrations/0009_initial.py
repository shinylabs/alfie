...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ramens_ramen', (
            ...
            ('cogs', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('msrp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ...
            ('boxed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        ...
        db.create_table('ramens_box', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slots', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
