...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Box.updated'
        db.add_column('ramens_box', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Box.name'
        raise RuntimeError("Cannot reverse this migration. 'Box.name' and its values cannot be restored.")
        # Deleting field 'Box.updated'
        db.delete_column('ramens_box', 'updated')
