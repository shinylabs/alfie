...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ramen.image_url'
        db.add_column('ramens_ramen', 'image_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ramen.saved_image'
        db.add_column('ramens_ramen', 'saved_image',
                      self.gf('django.db.models.fields.files.ImageField')(default=datetime.datetime(2012, 11, 25, 0, 0), max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ramen.image_url'
        db.delete_column('ramens_ramen', 'image_url')

        # Deleting field 'Ramen.saved_image'
        db.delete_column('ramens_ramen', 'saved_image')
