...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('services_service', 'category')

        # Adding field 'Service.issue'
        db.add_column('services_service', 'issue',
    ...
    def backwards(self, orm):
        ...
        db.add_column('services_service', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.issue'
        db.delete_column('services_service', 'issue')
    ...
    models = {
        ...
        'services.service': {
            ...
            'resolution': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
