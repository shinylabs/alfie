...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.resolution'
        db.delete_column('services_service', 'resolution')

        # Adding field 'Service.resolved'
        db.add_column('services_service', 'resolved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.resolution'
        db.add_column('services_service', 'resolution',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Service.resolved'
        db.delete_column('services_service', 'resolved')
