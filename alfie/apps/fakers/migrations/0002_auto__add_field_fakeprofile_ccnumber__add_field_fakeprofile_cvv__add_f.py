...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FakeProfile.ccnumber'
        db.add_column('fakers_fakeprofile', 'ccnumber',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FakeProfile.cvv'
        db.add_column('fakers_fakeprofile', 'cvv',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FakeProfile.exp_month'
        db.add_column('fakers_fakeprofile', 'exp_month',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FakeProfile.exp_year'
        db.add_column('fakers_fakeprofile', 'exp_year',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FakeProfile.ccnumber'
        db.delete_column('fakers_fakeprofile', 'ccnumber')

        # Deleting field 'FakeProfile.cvv'
        db.delete_column('fakers_fakeprofile', 'cvv')

        # Deleting field 'FakeProfile.exp_month'
        db.delete_column('fakers_fakeprofile', 'exp_month')

        # Deleting field 'FakeProfile.exp_year'
        db.delete_column('fakers_fakeprofile', 'exp_year')
