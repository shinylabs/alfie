...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FakeProfile.stripe_token'
        db.delete_column('fakers_fakeprofile', 'stripe_token')


    def backwards(self, orm):
        # Adding field 'FakeProfile.stripe_token'
        db.add_column('fakers_fakeprofile', 'stripe_token',
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'payment_attempts': ('django.db.models.fields.IntegerField', [], {'default': "'0'", 'null': 'True', 'blank': 'True'}),
