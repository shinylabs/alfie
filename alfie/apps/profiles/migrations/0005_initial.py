...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('address_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('shipping_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
