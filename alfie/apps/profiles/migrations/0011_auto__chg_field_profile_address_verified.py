...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.address_verified'
        db.alter_column('profiles_profile', 'address_verified', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.address_verified'
        db.alter_column('profiles_profile', 'address_verified', self.gf('django.db.models.fields.BooleanField')())
