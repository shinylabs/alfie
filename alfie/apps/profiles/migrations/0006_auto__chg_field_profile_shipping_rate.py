...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.shipping_rate'
        db.alter_column('profiles_profile', 'shipping_rate', self.gf('django.db.models.fields.IntegerField')(max_length=7, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.shipping_rate'
        db.alter_column('profiles_profile', 'shipping_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
