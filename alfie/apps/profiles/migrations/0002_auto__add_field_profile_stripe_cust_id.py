...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.stripe_cust_id'
        db.add_column('profiles_profile', 'stripe_cust_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.stripe_cust_id'
        db.delete_column('profiles_profile', 'stripe_cust_id')
