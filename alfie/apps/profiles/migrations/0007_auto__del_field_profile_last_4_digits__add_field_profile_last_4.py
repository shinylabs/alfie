...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.last_4_digits'
        db.delete_column('profiles_profile', 'last_4_digits')

        # Adding field 'Profile.last_4'
        db.add_column('profiles_profile', 'last_4',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.last_4_digits'
        db.add_column('profiles_profile', 'last_4_digits',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.last_4'
        db.delete_column('profiles_profile', 'last_4')
