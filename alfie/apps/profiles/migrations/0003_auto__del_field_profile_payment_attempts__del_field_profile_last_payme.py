...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.payment_attempts'
        db.delete_column('profiles_profile', 'payment_attempts')

        # Deleting field 'Profile.last_payment_attempt'
        db.delete_column('profiles_profile', 'last_payment_attempt')

        # Adding field 'Profile.address_verified'
        db.add_column('profiles_profile', 'address_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.shipping_rate'
        db.add_column('profiles_profile', 'shipping_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Profile.stripe_token'
        db.add_column('profiles_profile', 'stripe_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.overdue'
        db.add_column('profiles_profile', 'overdue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.payment_attempts'
        db.add_column('profiles_profile', 'payment_attempts',
                      self.gf('django.db.models.fields.IntegerField')(default='0', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.last_payment_attempt'
        db.add_column('profiles_profile', 'last_payment_attempt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.address_verified'
        db.delete_column('profiles_profile', 'address_verified')

        # Deleting field 'Profile.shipping_rate'
        db.delete_column('profiles_profile', 'shipping_rate')

        # Deleting field 'Profile.stripe_token'
        db.delete_column('profiles_profile', 'stripe_token')

        # Deleting field 'Profile.overdue'
        db.delete_column('profiles_profile', 'overdue')
